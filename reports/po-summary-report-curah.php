...
SUM(CASE WHEN t.payment_id IS NULL AND t.notim_status = 0 AND t.slip_retur IS NULL THEN t.unit_price * t.quantity ELSE 0 END) AS hutang,c.quantity, u.user_name, c.entry_date,
