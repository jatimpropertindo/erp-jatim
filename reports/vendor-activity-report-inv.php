...
//            $("#transactionContainer").hide();
        ...
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/vendor-activity-report.php', {
...
<form method="post" id="downloadxls" action="reports/vendor-activity-report-xls.php">
...
<li class="active">Vendor Activity Report</li>
