...
$sql = "SELECT t.*,
	    ...
	    CASE WHEN t.transaction_type = 2 THEN (SELECT b.freight_rule FROM freight_cost_local_sales a 
            ...
            WHEN t.transaction_type = 2 THEN (SELECT amount FROM general_ledger WHERE transaction_id = t.transaction_id AND account_id = 8) ELSE con.price_converted END AS pks_price ,
	...
	LEFT JOIN labor l ON l.labor_id = t.labor_id
        ...
        {$whereProperty} 
		GROUP BY t.transaction_id ORDER BY t.transaction_date ASC, t.slip_no ASC";
	//echo $sql;
$result = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/complete-report.php', {
...
<form method="post" id="downloadxls" action="reports/complete-report-xls.php">
...
<table class="table table-bordered table-striped" style="font-size: 8pt;">
    ...
    <tbody>
        ...
        <tr>
			...
			<td style="text-align: right;"><?php echo number_format($row->klaim_susut_add, 2, ".", ","); ?></td>
