...
if(isset($_POST['paymentFrom']) && $_POST['paymentFrom'] != '' && isset($_POST['paymentTo']) && $_POST['paymentTo'] != '') {
	...
	$whereProperty5 .= "AND (CASE WHEN (SELECT p.edit_date FROM payment p WHERE p.payment_id = (SELECT payment_id FROM general_ledger WHERE general_ledger_module = 'RETURN PAYMENT' AND general_ledger_for = 3 AND t_id = t.transaction_id LIMIT 1)) >= STR_TO_DATE('{$paymentTo}', '%d/%m/%Y')
	THEN (SELECT p.payment_date FROM payment p WHERE p.payment_id = (SELECT payment_id FROM general_ledger WHERE general_ledger_module = 'RETURN PAYMENT' AND general_ledger_for = 3 AND t_id = t.transaction_id AND payment_id = t.fc_payment_id LIMIT 1))
	ELSE (SELECT payment_date FROM jatim_inventory.payment WHERE payment_id = t.fc_payment_id AND payment_status = 0 AND payment_method = 1 AND payment_date BETWEEN STR_TO_DATE('{$paymentFrom}', '%d/%m/%Y') AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y')) END) IS NULL";
	...
	$whereProperty5 .= "AND (CASE WHEN (SELECT p.edit_date FROM payment p WHERE p.payment_id = (SELECT payment_id FROM general_ledger WHERE general_ledger_module = 'RETURN PAYMENT' AND general_ledger_for = 3 AND t_id = t.transaction_id LIMIT 1)) >= STR_TO_DATE('{$paymentFrom}', '%d/%m/%Y')
	THEN (SELECT p.payment_date FROM payment p WHERE p.payment_id = (SELECT payment_id FROM general_ledger WHERE general_ledger_module = 'RETURN PAYMENT' AND general_ledger_for = 3 AND t_id = t.transaction_id AND payment_id = t.fc_payment_id LIMIT 1))
	ELSE (SELECT payment_date FROM jatim_inventory.payment WHERE payment_id = t.fc_payment_id AND payment_status = 0 AND payment_method = 1 AND payment_date >= STR_TO_DATE('{$paymentFrom}', '%d/%m/%Y')) END) IS NULL";
	...
	$whereProperty5 .= "AND (CASE WHEN (SELECT p.edit_date FROM payment p WHERE p.payment_id = (SELECT payment_id FROM general_ledger WHERE general_ledger_module = 'RETURN PAYMENT' AND general_ledger_for = 3 AND t_id = t.transaction_id LIMIT 1)) >= STR_TO_DATE('{$paymentTo}', '%d/%m/%Y')
	THEN (SELECT p.payment_date FROM payment p WHERE p.payment_id = (SELECT payment_id FROM general_ledger WHERE general_ledger_module = 'RETURN PAYMENT' AND general_ledger_for = 3 AND t_id = t.transaction_id AND payment_id = t.fc_payment_id LIMIT 1))
	ELSE (SELECT payment_date FROM jatim_inventory.payment WHERE payment_id = t.fc_payment_id AND payment_status = 0 AND payment_method = 1 AND payment_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y')) END) IS NULL";
	
	$whereProperty6 .= "AND (CASE WHEN t.slip_no = 'BEN-20-0000003429' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140820 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003430' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140820 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003431' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140820 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003432' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140820 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003424' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140823 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003425' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140823 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003426' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140825 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003427' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140825 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003434' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140827 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	WHEN t.slip_no = 'BEN-20-0000003435' THEN (SELECT rpt_upload_id FROM rpt_upload WHERE rpt_upload_id = 140827 AND account_no = '210103' AND gl_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))
	ELSE
	(SELECT t2.fc_payment_id FROM jatim_inventory.`transaction` t2 LEFT JOIN jatim_inventory.payment p ON p.payment_id = t2.fc_payment_id 
	WHERE t2.transaction_id = t.`transaction_id` AND p.payment_date BETWEEN '2017-01-01' AND STR_TO_DATE('{$paymentTo}', '%d/%m/%Y'))END ) IS NULL";
...
c.po_no, c.contract_no, t.`send_weight`, t.`netto_weight`, t.`quantity`, t.`freight_price`, ftx.tax_category, ftx.tax_value as pph,
CASE WHEN f.freight_rule = 1 THEN ROUND((t.freight_price * t.freight_quantity),5) ELSE ROUND((t.freight_price * t.freight_quantity),5) END AS total_oa, 
...
LEFT JOIN jatim_inventory.tax ftx ON ftx.tax_id = t.fc_tax_id
...
AND (SELECT jurnal_date FROM adjustment_oa_ob WHERE jurnal_date < STR_TO_DATE('31/08/2021', '%d/%m/%Y') AND adj_id = t.adj_oa) IS NULL
UNION ALL
	  ...
	  var wto;
        $('#downloadxls').submit(function (e) {
            ...
            wto = setTimeout(function () {
                ...
                $('#dataContent').load('reports/hdoa-report.php', {
				...
				freightId: $('input[id="freightId"]').val(),
				stockpileId: $('input[id="stockpileId"]').val(),
				vendorFreightId: $('input[id="vendorFreightId"]').val()
         ...
         <form class="form-horizontal" id="downloadxls" method="post" action="reports/hdoa-report-xls.php" >
...
<table class="table table-bordered table-striped" style="font-size: 8pt;">
    <thead>
        <tr>
			...
			<th>Total DPP</th>
			<th>Total Biaya Angkut (Exclude PPn)</th>
			<!--<th>Total Susut</th>
