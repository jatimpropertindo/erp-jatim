...
CASE WHEN shipment_no='SC/JPJ/2306/REN/1' THEN 8649496983.69785
WHEN sl.localSales = 1 THEN (IFNULL((SELECT gl.amount FROM general_ledger gl LEFT JOIN account a ON a.account_id = gl.account_id WHERE a.account_no = 160100 AND gl.transaction_id = t.`transaction_id` ),0))
ELSE 
...
CASE  WHEN shipment_no='SC/JPJ/2306/REN/1' THEN 8649496983.69785
WHEN SUBSTR(shipment_no,-2,2) = '-S' THEN IFNULL((SELECT gl.amount FROM general_ledger gl LEFT JOIN account a ON a.account_id = gl.account_id WHERE a.account_no = 510201 AND gl.transaction_id = t.`transaction_id`),0)
WHEN sl.localSales = 1 THEN (IFNULL((SELECT gl.amount FROM general_ledger gl LEFT JOIN account a ON a.account_id = gl.account_id WHERE a.account_id = 546 AND gl.transaction_id = t.`transaction_id`),0))
...
CASE WHEN sl.localSales = 1 THEN (IFNULL((SELECT gl.amount FROM general_ledger gl LEFT JOIN account a ON a.account_id = gl.account_id WHERE a.account_id = 545 AND gl.transaction_id = t.`transaction_id`),0))
ELSE
...
CASE WHEN sl.localSales = 1 THEN (IFNULL((SELECT gl.amount FROM general_ledger gl LEFT JOIN account a ON a.account_id = gl.account_id WHERE a.account_id = 547 AND gl.transaction_id = t.`transaction_id`),0))
ELSE
...
CASE WHEN sl.localSales = 1 THEN (IFNULL((SELECT gl.amount FROM general_ledger gl LEFT JOIN account a ON a.account_id = gl.account_id WHERE a.account_id = 548 AND gl.transaction_id = t.`transaction_id`),0))
ELSE
