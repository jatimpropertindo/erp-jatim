...
'' AS contract_id, '' AS invoice_id, '' AS invoice_notim_id, '' AS transaction_id, '' AS t_id, '' AS payment_id, '' AS jurnal_id, '' AS accrue_id, '' AS i_id, '' AS cash_id, '' AS account_id, '' AS description, ru.amounts AS amount, ru.entry_by AS entry_by,
