 ...
 $(document).ready(function () {
    ...
    //            alert($('#addNew').attr('href'));
               ...
               e.preventDefault();
                ...
                $('#addDetailModal').modal('show');
    //            alert($('#addNew').attr('href'));
                $('#addDetailModalForm').load('forms/detail-pd.php', {pgId: menu[1]}, iAmACallbackFunction2);	//and hide the rotating gif
               ...
               e.preventDefault();
                ...
                $('#addDetailModal').modal('show');
    //            alert($('#addNew').attr('href'));
                $('#addDetailModalForm').load('forms/detail-psf.php', {pgId: menu[1]}, iAmACallbackFunction2);	//and hide the rotating gif
...
(SELECT SUM(tamount) FROM pengajuan_general_detail WHERE pg_id = a.pengajuan_general_id) AS totalAmount, a.file
