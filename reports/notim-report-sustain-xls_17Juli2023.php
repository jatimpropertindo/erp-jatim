...
$objPHPExcel->getActiveSheet()->setCellValue("F{$rowActive}", "PKS Name");
$objPHPExcel->getActiveSheet()->setCellValue("G{$rowActive}", "Certification");
$objPHPExcel->getActiveSheet()->setCellValue("H{$rowActive}", "Supplier/Customer");
$objPHPExcel->getActiveSheet()->setCellValue("I{$rowActive}", "Transaction Type");
$objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", "Send Weight");
$objPHPExcel->getActiveSheet()->setCellValue("K{$rowActive}", "Contract Type");
$objPHPExcel->getActiveSheet()->setCellValue("L{$rowActive}", "Inventory");
$objPHPExcel->getActiveSheet()->setCellValue("M{$rowActive}", "Balance (Q)");
...
/*if($boolBalanceBefore) {
    ...
    $objPHPExcel->getActiveSheet()->setCellValue("F{$rowActive}", $row->pks);
    $objPHPExcel->getActiveSheet()->setCellValue("G{$rowActive}", $row->certification);
    $objPHPExcel->getActiveSheet()->setCellValue("H{$rowActive}", $row->supplier);
    $objPHPExcel->getActiveSheet()->setCellValue("I{$rowActive}", $row->transaction_type2);
    $objPHPExcel->getActiveSheet()->setCellValue("J{$rowActive}", $row->send_weight);
    $objPHPExcel->getActiveSheet()->setCellValue("K{$rowActive}", $row->contract_type2);
    $objPHPExcel->getActiveSheet()->setCellValue("L{$rowActive}", $row->quantity);
    $objPHPExcel->getActiveSheet()->setCellValue("M{$rowActive}", $row->balance);
