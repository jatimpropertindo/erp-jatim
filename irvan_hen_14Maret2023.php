        ...
        if ($grandTotal != '' && $boolContinue) {
            ...
            if ($boolContinue) {
                ...
                if ($_POST['_method'] == 'INSERT') {
                    ...
                    if ($invoiceNo2Check && ($reqPaymentDate != 'NULL' || $reqPaymentDate != '')) {
                        //TransaksiPO = 2 True
...
//							if ($reqPaymentDate == NULL || $paymentType == 0 || $reqPaymentDate == '') {
							if ($reqPaymentDate == NULL || $reqPaymentDate == '') {
                        ...
                        echo '|FAIL| Original Invoice No Tidak Boleh Sama! atau tipe Payment harus di isi';
                        die();
                    }
