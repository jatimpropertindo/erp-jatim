...
$sql = "SELECT a.*,b.nama, e.user_name, f.shipment_no,
...
LEFT JOIN shipment f ON f.shipment_id = a.shipment_id ORDER BY a.sa_id DESC";
        ...
        $('#contentTable a').click(function(e){
            ...
            var menu = linkId.split('|');
		 	if (menu[0] == 'print') {
				...
				if(menu[3] == 2){
                $('#dataContent').load('forms/print-non-adv.php', {sa_id: menu[2]}, iAmACallbackFunction2);
				}else{
				$('#dataContent').load('forms/print-non-settle.php', {sa_id: menu[2]}, iAmACallbackFunction2);	
				}
                ...
                $('#dataContent').load('forms/non-adv_settle.php', {sa_id: menu[2]}, iAmACallbackFunction2);
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                if(parseInt(returnVal[3])!=0)	//if no errors
                                {
                                    ...
                                    if(returnVal[1] == 'OK') {
                                        $('#dataContent').load('contents/non-adv_settle.php', {}, iAmACallbackFunction2);
                                    }
                                }
                            }
                        });
...
<a href="#addNew|non-adv_settle" id="addNew" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 5px;" /> Add Advance/Settlement Non Perdin</a>
        ...
        <tr>
            <td>
                <div style="text-align: center;">
                    <a href="#" id="print|non-adv_settle|<?php echo $rowData->sa_id; ?>|<?php echo $rowData->sa_method; ?>" role="button" title="Print"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
					<?php if(($rowData->invoice_status == 0)) {
                    ?>
					<?php if($rowData->sa_method == 1){?>
					<a href="#" id="edit|non-adv_settle|<?php echo $rowData->sa_id; ?>" role="button" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
					<?php
                    }
                    ?>
                    <a href="#" id="delete|non-adv_settle|<?php echo $rowData->sa_id; ?>" role="button" title="Delete"><img src="assets/ico/gnome-trash.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
					<?php
                    }
                    ?>
                </div>
