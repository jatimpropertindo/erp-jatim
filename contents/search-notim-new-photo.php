...
$sql = "CALL SearchNotimNew2({$_SESSION['userId']},{$_SESSION['companyId']}, {$periodFrom}, {$periodTo}, '{$notim}');";
...
//                filter_reset : ".reset"
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/print-notim-new.php', {transactionId: menu[2]}, iAmACallbackFunction2);
        ...
        <tr>
            <td>
                <div style="text-align: center;">
					...
					?>
					<a href="#" id="showPhoto|transaction|<?php echo $rowData->transaction_id; ?>" role="button" title="Show Photo"><img src="assets/ico/photo-1.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
					<a href="#" id="showTruck|transaction|<?php echo $rowData->transaction_id; ?>" role="button" title="Show Truck Photo"><img src="assets/ico/photo-2.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
			...
			<td><div style="text-align: center;"><a href="#" id="jurnal|transaction|<?php echo $rowData->transaction_id; ?>" role="button" title="View Jurnal"><img src="assets/ico/view-jurnal.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a><div></td>
			<?php } ?>
