...
<table class="table table-bordered table-striped" id="contentTable" style="font-size: 9pt;">
    ...
    <tbody>
        ...
        <tr>
			...
			<td><div style="text-align: center;"><a href="#" id="jurnal|journal-invoice|<?php echo $rowData->invId; ?>|<?php echo $rowData->invoice_status ?>" role="button" title="View Jurnal"><img src="assets/ico/view-jurnal.png" width="18px" height="18px" style="margin-bottom: 5px;" /> </a></div></td>
