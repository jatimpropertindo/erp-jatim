...
CASE WHEN pp.payment_type = 2 THEN 'OUT' ELSE 'IN' END AS tipe, 
	...
	ELSE '' END AS vendorName, 
        ...
        CASE WHEN pp.status = 0 THEN 'PENGAJUAN' 
             ...
             WHEN pp.status = 4 THEN 'RETURNED' 
       ...
       FROM pengajuan_payment_sales pp 
        ...
        WHERE us.user_id = {$_SESSION['userId']} ORDER BY idPP DESC, pp.status DESC";
//echo $sql;
       ...
       $('#addNew').click(function (e) {
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'print') {
                ...
                $('#dataContent').load('forms/print-payment-local-sales.php', {idpp: menu[2]}, iAmACallbackFunction2);
                ...
                alertify.confirm("Are you sure want to delete this record?", function(e) {
                    if (e) {
                        $.ajax({
                            ...
                            method: 'POST',
                            data: { action: 'delete_pengajuan_payment_sales',
                                idPP: menu[2]
                            },
                            success: function(data){
                                ...
                                if(parseInt(returnVal[3])!=0)	//if no errors
                                {
                                    ...
                                    if(returnVal[1] == 'OK') {
                                        $('#dataContent').load('contents/pengajuan-notim-sales-old.php', {}, iAmACallbackFunction2);
                                    }
                                }
                            }
                        });
...
<form class="form-horizontal" method="post" action="reports/pengajuan-notim-sales-old-xls.php" id="pengajuanDataForm">
    <div class="row-fluid">
        <a href="#addNew|pengajuan-notim-sales-old" id="addNew" class = "btn" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 0px;"/> Add pengajuan</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                if($rowData->status1 == 'PENGAJUAN'){
                    ...
                    echo $rowData->status1;
                    echo "</td>";
                }else if ($rowData->status1 == 'CANCELED' || $rowData->status1 == 'RETURNED') {
