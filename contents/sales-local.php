...
WHERE sl.company_id = {$_SESSION['companyId']} AND sl.localSales = 1 AND sl.so_id IS NOT NULL
GROUP BY sl.sales_id
...
//            alert($('#addNew').attr('href'));
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/salesCode-local2.php', {salesId: menu[2],assign_po: menu[3]}, iAmACallbackFunction2);
...
<a href="#addNew|salesCode-local" id="addNew" role="button"><img src="assets/ico/add.png" width="18px" height="18px" style="margin-bottom: 5px;" /> Add Local Sales Code</a>
        ...
        <tr>
            <td>
				...
				<?php if ($rowData->sales_status != 4){?>
                    <a href="#" id="edit|sales|<?php echo $rowData->sales_id; ?>|<?php echo $rowData->assign_po; ?>" role="button" title="Edit"><img src="assets/ico/gnome-edit.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
            ...
            <td><?php echo $rowData->salesCode; ?></td>
