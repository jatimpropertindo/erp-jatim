...
//                filter_reset : ".reset"
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'edit') {
                ...
                $('#dataContent').load('forms/search-payment-new.php', {paymentId: menu[2], direct: 0}, iAmACallbackFunction2);
    ...
    //            alert($('#addNew').attr('href'));
                ...
                $('#dataContent').load('forms/search-payment_return-new.php', {paymentId: menu[2], direct: 0}, iAmACallbackFunction2);
    ...
    <tbody>
        ...
        <tr>
            <td>
				...
				<?php if($rowData->payment_status == 'SUCCESS' && (($rowData->payment_for == 'PKS Curah' && $rowData->payment_curah_id != '') 
                || ($rowData->payment_for == 'Freight Cost' && $rowData->payment_oa_id != '') 
                || ($rowData->payment_for == 'Unloading Cost' && $rowData->payment_ob_id != '') 
                || ($rowData->payment_for == 'Handling Cost' && $rowData->payment_handling_id != ''))){ ?>
                    
					<a href="#" id="edit_new|payment1|<?php echo $rowData->payment_id; ?>" role="button" title="Print"><img src="assets/ico/preview.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
					
				<?php } elseif($rowData->payment_status != 'SUCCESS' && ($rowData->payment_for == 'PKS Curah' || $rowData->payment_for == 'Freight Cost' || $rowData->payment_for == 'Unloading Cost' || $rowData->payment_for == 'Handling Cost')){ ?>
				
                    <a href="#" id="preview|payment1|<?php echo $rowData->payment_id; ?>" role="button" title="Print"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
					
                <?php } else { ?>
				    <a href="#" id="edit|payment|<?php echo $rowData->payment_id; ?>" role="button" title="Print"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                <?php
				}
                    if($allowDelete) {
                    ?>
            ...
            <td>
                <div style="text-align: center;">
                    <a href="#" id="jurnal|payment|<?php echo $rowData->payment_id; ?>" role="button" title="View Jurnal"><img src="assets/ico/view-jurnal.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                </div>
            </td>
			<?php } ?>
