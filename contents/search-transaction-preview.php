...
$sql = "SELECT  sh.shipment_code,
        ...
        WHERE  tt.status IN (0,2) order by entry_date DESC";
        ...
        <tr>
            <td>
                <div style="text-align: center;">
					<a href="#" id="edit|search-transaction-preview|<?php echo $rowData->temp_transaction_id; ?>" role="button" title="preview"><img src="assets/ico/preview-2.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                </div>
            </td>
            <?php
