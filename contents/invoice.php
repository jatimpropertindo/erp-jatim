...
<table class="table table-bordered table-striped" id="contentTable" style="font-size: 9pt;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <div style="text-align: center;">
                    <a href="#" id="jurnal|invoice|<?php echo $rowData->invoice_id; ?>" role="button" title="View Jurnal"><img src="assets/ico/view-jurnal.png" width="18px" height="18px" style="margin-bottom: 5px;" /> </a>
                </div>
            </td>
			<?php } ?>
