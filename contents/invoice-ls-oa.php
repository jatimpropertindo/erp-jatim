...
$sql = "SELECT CASE WHEN pp.payment_method = '1' THEN 'Claim Payment'
        ...
        CASE WHEN pp.vendor_id <> 0 THEN ven.vendor_name 
            ...
            WHEN pp.vendor_handling_id <> 0 THEN vh.handling_name 
...
WHEN pp.status = 5 THEN 'REJECTED' ELSE 'APPROVED' END AS statuspengajuan,
        ...
        FROM pengajuan_payment_sales_oa pp LEFT JOIN vendor ven ON ven.vendor_id = pp.vendor_id 
        ...
        LEFT JOIN labor_local_sales l ON l.labor_id = pp.labor_id 
        ...
        LEFT JOIN handling_local_sales_bank vhb ON vhb.h_bank_id = pp.vendor_bank_id 
        LEFT JOIN stockpile sp ON sp.stockpile_id = pp.stockpile_id
        LEFT JOIN USER us ON us.user_id = pp.user 
        LEFT JOIN invoice_sales_oa ino ON ino.idpp = pp.idpp
    ...
    //     });
        ...
        $('#contentTable a').click(function(e){
            ...
            if (menu[0] == 'approve') {
                ...
                $('#dataContent').load('forms/invoice-ls-oa.php', {idPP: menu[2], direct: 0}, iAmACallbackFunction2);
                ...
                $('#dataContent').load('forms/print-invoice-local-sales.php', {invId: menu[2]}, iAmACallbackFunction2);
...
<table class="table table-bordered table-striped" id="contentTable" style="font-size: 9pt;">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <div style="text-align: center;">
                    <?php if($rowData->statuspengajuan != 'PENGAJUAN'){ ?>
                        <a href="#" id="print|preview-forms|<?php echo $rowData->invId; ?>" role="button" title="Preview"><img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a> 
                    <?php } ?>
			...
			<?php if($rowData->urgentType == 'URGENT'){
