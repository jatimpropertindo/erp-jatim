...
$sql = "SELECT a.sl_lc_id, fl.labor_cost_id, CONCAT(f.labor_code, ' - ' , f.labor_name) AS labor_name,  a.entry_date, c.`currency_code`, fl.`price_converted`, fl.`active_from`, fl.`remarks`, s.`stockpile_name`, co.`customer_name`, u.user_name, a.entry_by
FROM sales_local_lc a
LEFT JOIN labor_cost_local_sales fl ON a.`lc_id` = fl.`labor_cost_id`
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                if(parseInt(returnVal[3])!=0)	//if no errors
                                {
                                    ...
                                    if(returnVal[1] == 'OK') {
                                        $('#salesOrder-local-lc').load('tabs/salesOrder-local-lc.php', {salesId: $('input[id="salesId"]').val()}, iAmACallbackFunction2());
                                    }
                                }
                            }
                        });
...
<div width="100%" style="overflow-x: auto; overflow-y: visible;">
    <table class="tablesorter" id="tabTablelc" style="font-size: 9pt;">
        <thead>
            <tr>
                <th>Action</th>
                <th>labor</th>
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        ...
                        <a href="#" id="delete|stockpile-labor|<?php echo $rowData->sl_lc_id; ?>" title="Delete"><img src="assets/ico/gnome-trash.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>
                </td>
