...
//        }
    ...
    $sql = "SELECT a.*,b.general_vendor_name, e.user_name, f.shipment_no, g.stockpile_name,
...
WHERE a.stockpile_id = 10 AND a.upload_status = 1
ORDER BY a.sa_id DESC, a.invoice_status ASC";
...
//            alert($('#addNew').attr('href'));
        ...
        $('#contentTable a').click(function (e) {
            ...
            if (menu[0] == 'approve') {
                ...
                $('#dataContent').load('forms/approve-pengajuan-non-perdin.php', {pgId: menu[2]}, iAmACallbackFunction2);
