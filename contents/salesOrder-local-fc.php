...
$sql = "SELECT a.sl_fc_id, fl.freight_cost_id, CONCAT(f.freight_code, ' - ' , f.freight_supplier) AS freight_name,  a.entry_date, c.`currency_code`, fl.`price_converted`, fl.`active_from`, fl.`remarks`, s.`stockpile_name`, co.`customer_name`, u.user_name, a.entry_by
FROM sales_local_fc a
LEFT JOIN freight_cost_local_sales fl ON a.`fc_id` = fl.`freight_cost_id`
                        ...
                        $.ajax({
                            ...
                            success: function(data){
                                ...
                                if(parseInt(returnVal[3])!=0)	//if no errors
                                {
                                    ...
                                    if(returnVal[1] == 'OK') {
                                        $('#salesOrder-local-fc').load('tabs/salesOrder-local-fc.php', {salesId: $('input[id="salesId"]').val()}, iAmACallbackFunction2());
                                    }
                                }
                            }
                        });
            ...
            <tr>
                <td>
                    <div style="text-align: center">
                        ...
                        <a href="#" id="delete|stockpile-freight|<?php echo $rowData->sl_fc_id; ?>" title="Delete"><img src="assets/ico/gnome-trash.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a>
                    </div>
                </td>
