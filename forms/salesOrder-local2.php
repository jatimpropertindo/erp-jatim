...
<script type="text/javascript">
    ...
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/sales-local-order.php', {}, iAmACallbackFunction);
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#salesOrder-local-data2" data-toggle="tab">Local Sales Order Details</a></li>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="salesOrder-local-data2">
