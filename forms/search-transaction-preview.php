...
$sql = "SELECT sp.stockpile_name, sp.stockpile_id, sp.stockpile_code, sh.shipment_code, s.`sales_no`, s.sales_id, c.`customer_name`,
        ...
        FORMAT(td.qty_uncertified,2) AS qtyUN, 
        tt.send_weight AS sendWeight2,
        ...
        tt.*, fls.freight_supplier FROM temp_transaction tt
        ...
        LEFT JOIN freight_cost_local_sales fcls ON fcls.freight_cost_id = tt.freight_cost_id
        LEFT JOIN freight_local_sales fls ON fls.freight_id = fcls.freight_id
...
if($result->num_rows == 1) {
    ...
    $freightCostSalesName = $row->freight_supplier;
    $freightCostSalesPrice = $row->freight_price;
    $freightCostSalesId = $row->freight_cost_id;
    $freightCostSalesQty = number_format($row->freight_quantity, 2, ".", ",");
    $driverSales = $row->driver;
    $sim = $row->sim;
    $doSales = $row->permit_no;
...
<form method="post" action="reports/temp-traceability-report-xls.php">
	...
	<input type="hidden"  id="transactionDate2" name="transactionDate2" value="<?php echo $transactionDate2; ?>" >
	<input type="hidden"  id="slipNo" name="slipNo" value="<?php echo $slipNo; ?>" >
...
<form method="post" id="transactionDataForm">
    ...
    <div class="row-fluid">   
        ...
        <div class="row-fluid">
            <div class="span2 lightblue">
                <label>Sales Frieght <span style="color: red;">*</span></label>
            </div>
            <div class="span4 lightblue">
                <input type="text" readonly class="span12" tabindex="5" id="freightCostSalesName" name="freightCostSalesName" value="<?php echo $freightCostSalesName; ?>">
                <input type="hidden" readonly class="span12" tabindex="14" id="freightCostSalesId" name="freightCostSalesId">
            </div>
            <div class="span2 lightblue">
                <label>DO No.</label>
            </div>
            <div class="span4 lightblue">
                <input type="text" readonly class="span12" tabindex="14" id="doSales" name="doSales" value = "<?php echo $doSales ?>">
				
            </div>
        </div>
        <div class="row-fluid">
            <div class="span2 lightblue">
                <label>Sales Frieght Cost<span style="color: red;">*</span></label>
            </div>
            <div class="span4 lightblue">
                <input type="text" readonly class="span12" tabindex="5" id="freightCostSalesPrice" name="freightCostSalesPrice" value="<?php echo $freightCostSalesPrice; ?>">
            </div>
            <div class="span2 lightblue">
        ...
        <div class="row-fluid">
            ...
            <div class="span4 lightblue">
                <input type="text" readonly class="span12" tabindex="5" id="driverSales" name="driverSales" value="<?php echo $driverSales; ?>">
            </div>
            <div class="span2 lightblue">
                <label>Driving License No.</label>
            </div>
            <div class="span4 lightblue">
                <input type="text" readonly class="span12" tabindex="14" id="sim" name="sim" value = "<?php echo $sim ?>">
