...
<script type="text/javascript">
    ...
    function loadConfig() {
        ...
        //alert(menu[1]);
        $('#' + menu[1]).load('tabs/' + menu[1] + '.php', {sa_id: $('input[id="sa_id"]').val()});
    }
...
<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#non-adv_settle" data-toggle="tab">Advance/Settlement</a></li>
</ul>

<div class="tab-content">
    <input type="hidden" id="sa_id" value="<?php echo $sa_id; ?>" />
    <div class="alert">
    ...
    <div class="tab-pane active" id="non-adv_settle">
