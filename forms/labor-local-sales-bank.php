...
if(isset($_POST['lBankId']) && $_POST['lBankId'] != '') {
    $lBankId = $_POST['lBankId'];

    // <editor-fold defaultstate="collapsed" desc="Query for labor Cost Data">

    $sql = "SELECT * FROM labor_local_sales_bank WHERE l_bank_id = {$lBankId}
            ";
    $resultData = $myDatabase->query($sql, MYSQLI_STORE_RESULT);

    if($resultData !== false && $resultData->num_rows > 0) {
        $rowData = $resultData->fetch_object();
		$lBankId = $rowData->l_bank_id;
...
<input type="hidden" id="lBankId" name="lBankId" value="<?php echo $lBankId; ?>">
<div class="row-fluid">
