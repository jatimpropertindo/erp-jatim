...
<ul class="nav nav-tabs" id="myTab">
   ...
   // if($boolShow) {
    ?>
    <li><a href="#endstock_iscc" data-toggle="tab">ISCC</a></li>
    <li><a href="#endstock_ggl" data-toggle="tab">GGL</a></li>
	<li><a href="#endstock_iscc_ggl" data-toggle="tab">ISCC + GGL</a></li>
...
<div class="tab-content">
    ...
    //if($boolShow) {
    ?>
    <div class="tab-pane" id="endstock_iscc">
	...
	<div class="tab-pane" id="endstock_iscc_ggl">
