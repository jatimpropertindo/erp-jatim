...
sl.salesCode, so.so_no,slc.sales_con_no, cus.customer_name, slc.inventory_rule
FROM TRANSACTION t 
...
<form method="post" id="transactionDataForm">
    ...
    <div id="outTransaction" style="display: none;">
        ...
        <div class="row-fluid">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="4" id="sendWeight2" name="sendWeight2" value="<?php echo $quantity; ?>">
            </div>
            <div class="span2 lightblue">
