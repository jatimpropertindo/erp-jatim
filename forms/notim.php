...
DATE_FORMAT(t.transaction_date, '%Y-%m') AS edit_date,
...
FORMAT(sl.quantity - (SELECT COALESCE(SUM(quantity), 0) FROM shipment WHERE sales_id = sl.sales_id), 2) AS quantity_available, tr.slip_no AS slipNo_retur, tr.transaction_id AS slipId_retur
FROM TRANSACTION t 
...
LEFT JOIN pengajuan_retur pr ON pr.slip_lama = t.transaction_id
LEFT JOIN `transaction` tr ON tr.transaction_id = pr.slip_retur
...
if($result->num_rows == 1) {
    ...
    $slipNo_retur = $row->slipNo_retur;
    $slipId_retur = $row->slipId_retur;
...
<form method="post" id="transactionDataForm">
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">
        ...
        <div class="span2 lightblue">
            <label>Slip Awal <span style="color: red;">*</span></label>
        </div>
        <div class="span4 lightblue">
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">
        ...
        <div class="span2 lightblue">
            <label>Slip Retur <span style="color: red;">*</span></label>
        </div>
        <div class="span4 lightblue">
			  <input type="text" readonly class="span12" tabindex="15" id="slipNo_retur" name="slipNo_retur" value="<?php echo $slipNo_retur; ?>">
              <input type="hidden" name="slipId_retur" id="slipId_retur" value="<?php echo $slipId_retur; ?>" />
        </div>
    ...
    <div id="outTransaction" style="display: none;">
        ...
        <div class="row-fluid">
            ...
            <div class="span4 lightblue">
                <input type="text"  readonly class="span12" tabindex="4" id="sendWeight2" name="sendWeight2" value="<?php echo $sendWeight; ?>">
            </div>
            <div class="span2 lightblue">
