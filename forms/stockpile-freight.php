...
<div class="row-fluid">
    ...
    <div class="span8 lightblue" id="exchangeRateFreight" style="display: none;">
        ...
        <input readonly type="text" class="span9" tabindex="4" id="exchangeRate" name="exchangeRate" value="<?php echo $exchangeRate; ?>">
    </div>
</div>
...
<div class="row-fluid">
    <div class="span12 lightblue">
        ...
        <input readonly type="text" class="span6" tabindex="5" id="price" name="price" value="<?php echo $price; ?>">
    </div>
</div>
<div class="row-fluid">
    <div class="span12 lightblue">
        <label>Active From <span style="color: red;">*</span></label>
        <input readonly type="date" class="span6" tabindex="6" id="active_from" name="active_from" value="<?php echo $active_from; ?>">
    </div>
</div>
<div class="row-fluid">
    <div class="span4 lightblue">
        <label>Shrink Tolerance(KG) <span style="color: red;"></span></label>
        <input readonly type="text" class="span12" tabindex="7" id="shrink_tolerance_kg" name="shrink_tolerance_kg" value="<?php echo $shrink_tolerance_kg; ?>">
    </div>
	<div class="span4 lightblue">
        <label>Shrink Tolerance(%) <span style="color: red;"></span></label>
        <input readonly type="text" class="span12" tabindex="7" id="shrink_tolerance_persen" name="shrink_tolerance_persen" value="<?php echo $shrink_tolerance_persen; ?>">
    </div>
	<div class="span4 lightblue">
        <label>Shrink Claim <span style="color: red;"></span></label>
        <input readonly type="text" class="span12" tabindex="7" id="shrink_claim" name="shrink_claim" value="<?php echo $shrink_claim; ?>">
    </div>
</div>
...
<div class="row-fluid">
    <div class="span12 lightblue">
        ...
        <input readonly type="text" class="span10" tabindex="6" id="paymentNotes" name="paymentNotes" value="<?php echo $paymentNotes; ?>">
    </div>
</div>
<div class="row-fluid">
    <div class="span12 lightblue">
        <label>No Kontrak</label>
        <input readonly type="text" class="span10" tabindex="6" id="contractPKHOA" name="contractPKHOA" value="<?php echo $contractPKHOA; ?>">
    </div>
</div>
<div class="row-fluid">
    <div class="span12 lightblue">
        <label>Status <span style="color: red;">*</span></label>
		 <textarea readonly class="span10" rows="3" tabindex="7" id="remarks" name="remarks"><?php echo $remarks; ?></textarea>
