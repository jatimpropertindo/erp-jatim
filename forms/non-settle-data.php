...
if(isset($_SESSION['settleNon'])) {
    $id_user = $_SESSION['settleNon']['id_user'];
...
function setUser(stockpile_id) {
	...
	<?php
        ...
        ?>
		//alert('bb');
		setAdvanceNon(<?php echo $id_user; ?>, <?php echo $stockpile_id; ?>);
		<?php
		}
        ?>	


function setAdvanceNon(id_user, stockpile_id) {
		//alert('aa');
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
...
<input type="hidden" id="action" name="action" value="non_settle_detail">
...
<div class="span4 lightblue">
            ...
            <input type="text" class="span12"  tabindex="" id="items" name="items" value="<?php echo $items ?>" > 
        </div> 	
    <div class="span5 lightblue">
