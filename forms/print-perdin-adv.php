...
<br>
   ...
   <table width="100%" style="table-layout:fixed; font-size: 9pt;">
	...
	<table width="100%" style="table-layout:fixed; font-size: 9pt;">
          ...
          <tr><td colspan="6" style="text-align: center; font-size: 10pt; font-weight: 600;" >FORM CASH ADVANCE</td></tr>
   ...
   <br>
	...
	if($row->sa_method == 2){
	$sql = "SELECT a.*, b.`jenis_benefit` AS notes, a.amount AS price, '' AS advance, a.keterangan, c.`uom_type`
    FROM perdin_adv_detail a
    LEFT JOIN perdin_benefit b ON a.benefit_id = b.benefit_id
    LEFT JOIN uom c ON c.`idUOM` = a.`uom`
			WHERE a.sa_id = {$sa_id}";
	$result = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
	...
	*/	
    ...
    <table width="50%" class="table table-bordered table-striped" style="font-size: 9pt;">
	 ...
	 ?>
                ...
                <td style="text-align: center;"><?php echo $row->uom_type;?></td>
