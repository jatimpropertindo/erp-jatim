...
$sql = "SELECT 100 AS `termin`, 1 AS `exchange_rate`, a.`total_qty` AS qty, a.price AS price, a.`total_dpp` AS amount_converted,
a.`total_ppn_amount` AS ppn_converted, a.`total_pph_amount` AS pph_converted, a.`grand_total` AS tamount_converted, a.`remarks` AS notes  
FROM pengajuan_payment_sales_oa a 
WHERE a.`idPP` = {$pgId}";
