...
if(isset($_POST['handlingCostId']) && $_POST['handlingCostId'] != '') {
    ...
    $sql = "SELECT fc.*, DATE_FORMAT(fc.modify_date, '%d %b %Y %H:%i:%s') AS modify_date2, u.user_name
            ...
            WHERE fc.handling_cost_id = {$handlingCostId}
            ";
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        ...
        $contractPKHOA = $rowData->contract_handling;
...
<div class="row-fluid">
    ...
    <div class="span8 lightblue" id="exchangeRatehandling" style="display: none;">
...
<div class="row-fluid"> 
    <div class="span12 lightblue">
            <label>handling Weight Rule <span style="color: red;">*</span></label>
            <?php
            createCombo("SELECT '1' as id, 'Buyer Weight' as info UNION
                        ...
                        SELECT '4' as id, 'Lowest Weight' as info;", $handlingRule, '', "handlingRule", "id", "info", 
                "", 6);
            ?>
        </div>
