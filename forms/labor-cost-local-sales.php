...
if(isset($_POST['laborCostId']) && $_POST['laborCostId'] != '') {
    $laborCostId = $_POST['laborCostId'];
    ...
    $sql = "SELECT fc.*, DATE_FORMAT(fc.modify_date, '%d %b %Y %H:%i:%s') AS modify_date2, u.user_name
            ...
            WHERE fc.labor_cost_id = {$laborCostId}
            ";
...
<input type="hidden" id="laborCostId" name="laborCostId" value="<?php echo $laborCostId; ?>">
...
<div class="row-fluid">
    ...
    <div class="span8 lightblue" id="exchangeRatelabor" style="display: none;">
...
<div class="row-fluid">
<div class="span12 lightblue">
            <label>labor Weight Rule <span style="color: red;">*</span></label>
            <?php
            createCombo("SELECT '1' as id, 'Buyer Weight' as info UNION
                        SELECT '2' as id, 'PKS Weight' as info UNION
                        SELECT '3' as id, 'Stockpile Weight' as info UNION    
                        SELECT '4' as id, 'Lowest Weight' as info;", $laborRule, '', "laborRule", "id", "info", 
                "", 6);
            ?>
        </div>
        </div>
