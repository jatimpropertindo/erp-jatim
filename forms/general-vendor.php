...
<script type="text/javascript">
    ...
    function back() {
        $.blockUI({ message: '<h4>Please wait...</h4>' }); 
        $('#pageContent').load('views/general-vendor.php', {}, iAmACallbackFunction);
    }
    
</script>

<ul class="nav nav-tabs" id="myTab">
    <li class="active"><a href="#general-vendor-data" data-toggle="tab">Vendor Details</a></li>
	<?php
    if($boolShow) {
    ?>
    <li><a href="#general-vendor-pph" data-toggle="tab">PPh</a></li>
	<li><a href="#general-vendor-bank-data" data-toggle="tab">Bank</a></li>
	<li style="display: none;"><a href="#general-vendor-email-data" data-toggle="tab">Email</a></li>
	 <?php
    }
    ?>
</ul>
...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="general-vendor-data">
	...
	<div class="tab-pane" id="general-vendor-email-data">
