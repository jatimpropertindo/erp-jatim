...
<script type="text/javascript">
    ...
    function sum() {
        ...
        //var result = (num5.toFixed(10) /100) * (num1.toFixed(10) * num2.toFixed(10));
        //var result1 = parseInt(num1) * parseInt(num2) + parseInt(num3) - parseInt(num4);
        if (!isNaN(result)) {
            document.getElementById('amount').value = result.toLocaleString('en-US', {minimumFractionDigits: 10});
