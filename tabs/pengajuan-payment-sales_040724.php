...
<div class="row-fluid" id="freightDownPayment" style="display: none;">
        ...
        <div class="span3 lightblue">
            ...
            <input name="ppnFreightDP1" type="checkbox" id="ppnFreightDP1" onclick="checktaxstatus()"/> 
            <input type="hidden" class="span12" readonly id="ppnFreightDP2" name="ppnFreightDP2" value="1">
        </div>
        <div class="span3 lightblue">
            ...
            <input name="pphFreightDP1" type="checkbox" id="pphFreightDP1" onclick="checktaxstatus()" />
            <input type="hidden" class="span12" readonly id="pphFreightDP2" name="pphFreightDP2" value="1">
        </div>
        <div class="span3 lightblue">
