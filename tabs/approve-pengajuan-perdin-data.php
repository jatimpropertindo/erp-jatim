...
//                                $("#successMsg").show();
		...
		// Added By Vembri
        $('#PengajuanDataForm a').click(function(e){
            e.preventDefault();
            //alert(this.id);
            $("#successMsgAll").hide();
            $("#errorMsgAll").hide();
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">
        ...
        <?php if (isset($docs) && $docs != '') { ?>
            <div class="span3 lightblue">
				...
				<!-- Updated By Vembri -->
				<a href="#" id="download|perdin-adv_settle|<?php echo $docs; ?>" role="button">View Documents<img src="assets/ico/file.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a></td>
            </div>
        <?php } ?>
        ...
        <?php if ($sa_method == 1) { ?>
        <div class="span3 lightblue">
            <label>HR Approval Document</label>
            <td><a href="#" id="print|perdin-adv_settle|<?php echo $rowData->sa_id; ?>" role="button">View Documents<img src="assets/ico/gnome-print.png" width="18px" height="18px" style="margin-bottom: 5px;" /></a></td>
        </div>
        <?php } ?>
...
<!-- Added By Vembri : Approved Doc Modal -->
