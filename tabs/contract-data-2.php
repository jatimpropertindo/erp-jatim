...
CASE WHEN con.qty_rule = 0 THEN 'SEND WEIGHT'
WHEN con.qty_rule = 1 THEN 'NETT0 WEIGHT'
ELSE 'LOWEST WEIGHT' END AS qty_rule2,
...
//            echo $sql;
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        ...
        $qty_rule2 = $rowData->qty_rule2;
		$quantity_rule = $rowData->quantity_rule;
...
<form method="post" id="contractDataForm">
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">   
       ...
       <div class="span2 lightblue">
            ...
            <input type="text" class="span12" readonly tabindex="" id="qty_rule2" name="qty_rule2" value="<?php echo $qty_rule2; ?>">
            <input type="hidden" class="span12" tabindex="" id="qty_rule" name="qty_rule" value="<?php echo $qty_rule; ?>">
        </div>
