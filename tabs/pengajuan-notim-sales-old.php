            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (parseInt(returnVal[3]) != 0)	//if no errors
                    {
                        ...
                        if (returnVal[1] == 'OK') {
                            $('#pageContent').load('views/pengajuan-notim-sales-old.php', {}, iAmACallbackFunction);
                        }
...
function resetContractSales(text) {
    ...
    function setContractSales(type, stockpileIdSales, customerId, contractNoDp) {
        $.ajax({
            ...
            method: 'POST',
            data: {
                action: 'getShipmentPaymentSalesOld',
                //stockpileId: stockpileId,
...
<form method="post" autocomplete="off" id="PengajuanPaymentDataForm" enctype="multipart/form-data">
    <input type="hidden" name="action" id="action" value="pengajuan_payment_sales_old" />
