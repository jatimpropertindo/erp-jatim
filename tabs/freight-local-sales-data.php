                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                ...
                                $('#dataContent').load('forms/freight-local-sales.php', { freightId: returnVal[3] }, iAmACallbackFunction2);
...
<form method="post" id="freightDataForm">
    <input type="hidden" name="action" id="action" value="freight_local_sales_data" />
    ...
    <div class="span4 lightblue">
            ...
            <?php
           /* createCombo("SELECT '1' as id, 'B/L Weight' as info UNION
                        SELECT '2' as id, 'Lowest' as info UNION
						SELECT '3' as id, 'Ritase' as info;", $freightRule, '', "freightRule", "id", "info", 
                "", 6);*/
            ?>
        </div>
        </div>-->
