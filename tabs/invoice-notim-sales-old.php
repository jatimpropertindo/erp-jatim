            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (parseInt(returnVal[4]) != 0)	//if no errors
                    {
                        ...
                        if (returnVal[1] == 'OK') {
                            $('#dataContent').load('forms/invoice-notim-sales-old.php', {idPP: <?php echo $idPP; ?>}, iAmACallbackFunction2);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (parseInt(returnVal[3]) != 0)	//if no errors
                    {
                        ...
                        if (returnVal[1] == 'OK') {
                            $('#pageContent').load('views/invoice-notim-sales-old.php', {idPP: returnVal[3], direct: 1}, iAmACallbackFunction);
                        }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (parseInt(returnVal[3]) != 0)	//if no errors
                {
                    ...
                    if (returnVal[1] == 'OK') {
                        $('#pageContent').load('views/invoice-notim-sales-old.php', {}, iAmACallbackFunction);
                    }
