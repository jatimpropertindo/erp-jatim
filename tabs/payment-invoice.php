...
<form method="post" id="paymentDataForm" >
    ...
    <div class="row-fluid" id="divInvoice" style="display: none;" >
        ...
        <div class="span4 lightblue">
            ...
            <input type="text" placeholder="DD/MM/YYYY" style="width: 350px" disabled tabindex="" id="invoiceDate" name="invoiceDate" data-date-format="dd/mm/yyyy" class="datepicker">
        </div>
