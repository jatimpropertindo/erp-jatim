...
if(isset($_POST['salesId']) && $_POST['salesId'] != '') {
    ...
    $sql = "SELECT sl.*, IFNULL(SUM(sh.quantity),0) AS qty_bl
    FROM sales sl
    LEFT JOIN shipment sh ON sl.sales_id = sh.sales_id
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                ...
                                $('#dataContent').load('forms/sales-local-order.php', { salesId: returnVal[3] }, iAmACallbackFunction2);
...
<form method="post" id="salesDataForm">
    ...
    <div class="row-fluid">
        ...
        <div class="span3 lightblue">
            ...
            <?php 
            createCombo("SELECT sales_con_id, sales_con_no FROM sales_local WHERE sales_con_status = 0", $sales_con_id, '', "sales_con_id", "sales_con_id", "sales_con_no", 
            "", 1, "select2combobox100", 1, "", false);
            ?>
            <input type="hidden" readonly class="span12" tabindex="1" id="salesNo" name="salesNo" value="<?php echo $salesNo; ?>">
        </div>
        <div class="span3 lightblue">
            <label>Sales Order Date <span style="color: red;">*</span></label>
            <input type="text" placeholder="DD/MM/YYYY" tabindex="2" id="salesOrderDate" name="salesOrderDate" value="<?php echo $salesOrderDate; ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
        </div>  
        <div class="span3 lightblue">
        <label>Qty Sales Order<span style="color: red;">*</span></label>
            <input type="text" class="span12" tabindex="3" id="qtySo" name="qtySo" value="<?php echo $qtySo; ?>">
        </div>
        <div class="span3 lightblue">
            <label>Sales Contract Date <span style="color: red;">*</span></label>
            <input type="text" disabled placeholder="DD/MM/YYYY" tabindex="" id="salesDate" name="salesDate" value="<?php echo $salesDate; ?>" data-date-format="dd/mm/yyyy" class="datepicker" >
        </div>  
    </div>
    <div class="row-fluid">   
        <div class="span3 lightblue">
    ...
    <div class="row-fluid">  
        <div class="span8 lightblue">
            <label>Notes</label>
            <textarea class="span12" rows="3" tabindex="4" id="notes" name="notes"><?php echo $notes; ?></textarea>
        </div>
