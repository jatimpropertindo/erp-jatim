...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#laborDataForm").validate({
            ...
            messages: {
                laborCode: "labor Code is a required field.",
				...
				laborRule: "Status is a required field."
            },
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[4]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                ...
                                $('#dataContent').load('forms/labor-local-sales.php', { laborId: returnVal[3] }, iAmACallbackFunction2);
...
<form method="post" id="laborDataForm">
    <input type="hidden" name="action" id="action" value="labor_local_sales_data" />
    <input type="hidden" name="laborId" id="laborId" value="<?php echo $laborId; ?>" />
    <div class="row-fluid">   
        <div class="span4 lightblue">
            <label>Code <span style="color: red;">*</span></label>
            <input type="text" class="span12" tabindex="1" id="laborCode" name="laborCode" value="<?php echo $laborCode; ?>">
        </div>
       <!-- <div class="span4 lightblue">
    ...
    <div class="row-fluid">  
        <div class="span4 lightblue">
            ...
            <input type="text" class="span12" tabindex="2" id="laborName" name="laborName" value="<?php echo $laborName; ?>">
        </div>
        <!--<div class="span4 lightblue">
