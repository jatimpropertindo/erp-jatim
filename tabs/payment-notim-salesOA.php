       ...
       /* $('#insertModal').on('hidden', function () {
		...
		if(document.getElementById('paymentFor1').value != '') {
			...
			if(document.getElementById('paymentFor1').value == 2) { //invoice OA
				...
				refreshInvoiceOBPayment(<?php echo $inv_notim_id; ?>);
				...
				//document.getElementById("remarks").readOnly = true;
				refreshInvoiceHandling($('input[id="invoiceId1"]').val(), $('input[id="paymentMethodText"]').val(), 'NONE', 'NONE');
				refreshInvoiceHandlingPayment(<?php echo $inv_notim_id; ?>);
...
//                        alert(data);
	...
	function refreshInvoiceOA(invoiceOAId, paymentMethodText) {
        ...
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
            data: { action: 'refreshInvoiceOA_sales',
	...
	function refreshInvoiceOB(invoiceOBId, paymentMethodText) {
        ...
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
            data: { action: 'refreshInvoiceOB_sales',
	...
	function refreshInvoiceHandling(invoiceHandlingId, paymentMethodText) {
        ...
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
            data: { action: 'refreshInvoiceHandling_sales',
    ...
    function refreshInvoiceOAPayment(invoiceOAId) {
        ...
        //if(amount != '') {
            $.ajax({
                url: 'get_data.php',
                method: 'POST',
                data: { action: 'refreshInvoiceOAPayment_sales',
                        invoiceOAId: invoiceOAId
                },
                success: function(data){
                    var returnVal = data.split('||');
    ...
    function refreshInvoiceOBPayment(invoiceOBId) {
        ...
        //if(amount != '') {
            $.ajax({
                url: 'get_data.php',
                method: 'POST',
                data: { action: 'refreshInvoiceOBPayment_sales',
                        invoiceOBId: invoiceOBId
                },
                success: function(data){
                    var returnVal = data.split('||');
    ...
    function refreshInvoiceHandlingPayment(invoiceHandlingId) {
        ...
        //if(amount != '') {
            $.ajax({
                url: 'get_data.php',
                method: 'POST',
                data: { action: 'refreshInvoiceHandlingPayment_sales',
                        invoiceHandlingId: invoiceHandlingId
                },
                success: function(data){
                    var returnVal = data.split('||');
