    ...
    $(document).ready(function () {
        $('#contentTable a').click(function (e) {
            ...
            if (menu[0] == 'detail') {
                ...
                //$("#modalErrorMsg").hide();
                $('#addDetailModal4').modal('show');
                //            alert($('#addNew').attr('href'));
                $('#addDetailModalForm4').load('forms/detail-endstock-rsb_ggl.php', {
                    period: menu[1],
...
<form method="post" action="tabs/endstock_iscc_ggl-xls.php">
...
<div id="addDetailModal4" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel"
     aria-hidden="true" style="width:1000px; height:500px; margin-left:-500px;">
    <form id="detailForm" method="post" style="margin: 0px;" action="reports/detailEndStock-rsb_ggl-xls.php">
        ...
        <div class="modal-body" id="addDetailModalForm4">
