...
if (isset($_POST['pgId']) && $_POST['pgId'] != '') {
    ...
    if ($resultData2 !== false && $resultData2->num_rows > 0) {
        ...
        $sqlGetPGD1 = "SELECT a.general_vendor_name, b.bank_name
        FROM general_vendor a 
        LEFT JOIN general_vendor_bank b ON a.general_vendor_id = b. general_vendor_id
        WHERE a.general_vendor_id = {$generalVendorId} AND gv_bank_id = {$gvBankId}";
        $resultData21 = $myDatabase->query($sqlGetPGD1, MYSQLI_STORE_RESULT);
        if ($resultData21 !== false && $resultData21->num_rows > 0) {
        $rowData21 = $resultData21->fetch_object();
        $general_vendor_name = $rowData21->general_vendor_name;
        $bank_name = $rowData21->bank_name;
        }
...
<form method="post" id="PengajuanDataForm" enctype="multipart/form-data">
    ...
    <div class="row-fluid" style="margin-bottom: 7px;">
        ...
        <div class="span3 lightblue">
            ...
            <input type="text" placeholder="DD/MM/YYYY" tabindex="" id="inputDate" name="inputDate"
                   value="<?php echo $inputDate; ?>" data-date-format="dd/mm/yyyy" class="datepicker" disabled>
        </div>
    </div>
    <div class="row-fluid" style="margin-bottom: 7px;">
        <div class="span3 lightblue">
    ...
    <div id="notPoTransaction" class="row-fluid" style="margin-bottom: 25px;">
        ...
        <div class="span4 lightblue" id="generalVendorIdLabel" style="display: none">
            ...
            ?>
            <input type="text" readonly class="span12" tabindex="" id="general_vendor_name" name="general_vendor_name" value="<?php echo $general_vendor_name; ?>" >
            <input type="hidden" class="span12" tabindex="" id="generalVendorId" name="generalVendorId" value="<?php echo $generalVendorId; ?>" >
        </div>
        <?php if ($gvBankId != '') { ?>
            <div class="span4 lightblue" id="vendorBankIdLabel" style="display: none">
                ...
                /*createCombo("SELECT gv_bank_id, CONCAT(bank_name,' - ',account_no) AS bank_name FROM general_vendor_bank WHERE general_vendor_id = {$generalVendorId}", "$gvBankId", "", "gvBankId", "gv_bank_id", "bank_name",
                    "", "", "select2combobox75", 1, "", true);*/
                ?>
                <input type="text" readonly class="span12" tabindex="" id="bank_name" name="bank_name" value="<?php echo $bank_name; ?>" >
                <input type="hidden" class="span12" tabindex="" id="gvBankId" name="gvBankId" value="<?php echo $gvBankId; ?>" >
            </div>
        <?php } else { ?>
            <div class="span4 lightblue" id="vendorBankIdLabel" style="display: none">
                <label>Vendor Bank <span style="color: red;">*</span></label>
    ...
    <div class="row-fluid">
        <div class="span12 lightblue">
            <button class="btn btn-primary" <?php echo $disabledProperty; ?>>Submit</button>
