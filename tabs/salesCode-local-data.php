...
//                        alert(data);
                if(data != '') {
					...
					document.getElementById('qty_so').value = returnVal[19];
...
<form method="post" id="salesDataForm">
    ...
    <div class="row-fluid">
        ...
        <div class="span3 lightblue">
            ...
            <?php 
            createCombo("SELECT so_id, so_no FROM sales_order WHERE status = 0", $so_id, '', "so_id", "so_id", "so_no", 
        ...
        <label>Qty Sales<span style="color: red;">*</span></label>
            <input type="text" class="span12" tabindex="3" id="quantity" name="quantity" value="<?php echo $quantity; ?>">
        </div>
    ...
    <div class="row-fluid">   
        ...
        <div class="span3 lightblue">
            ...
            <input type="hidden" readonly class="span12"  id="stockpileId2" name="stockpileId2" value="<?php echo $stockpileId2; ?>">
        </div>
        <div class="span3 lightblue">
    ...
    <label>Sales Code <span style="color: red;">*</span></label>
            <input type="text" readonly class="span12" tabindex="2" id="salesCode" name="salesCode" value="<?php echo $salesCode; ?>">
        </div>
        <div class="span3 lightblue">
        ...
        <div class="span3 lightblue">
            ...
            <input type="text" readonly class="span12"  id="qty_so" name="qty_so" value="<?php echo $qty_so; ?>">
    ...
    <div class="row-fluid"> 
        ...
        <!--<div class="span3 lightblue">
		<label>Sales Month <span style="color: red;">*</span></label>
        ...
        <div class="span3 lightblue">
            <label>Total Truck<span style="color: red;">*</span></label>
    ...
    <div class="row-fluid">  
        <div class="span8 lightblue">
            <label>Notes</label>
            <textarea class="span12" rows="3" tabindex="6" id="notes" name="notes"><?php echo $notes; ?></textarea>
        </div>
