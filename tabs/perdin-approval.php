...
//            echo $sql;
	...
	$sql2 = "CALL PlanPayDate(STR_TO_DATE('$inputDate', '%d/%m/%Y'))";
			$result2 = $myDatabase->query($sql2, MYSQLI_STORE_RESULT);
			if ($result2->num_rows == 1) {
				$row2 = $result2->fetch_object();
				
				$plan_pay_date = $row2->tglBayar;
...
<form method="post" id="AdvanceDataForm" autocomplete="off">
	...
	<div class="span3 lightblue">
		 ...
		 <input type="hidden" class="span12" readonly id="plan_pay_date" name="plan_pay_date" value="<?php echo $plan_pay_date; ?>">
            <?php
