    ...
    $(document).ready(function () {
        $('#contentTable a').click(function (e) {
            ...
            if (menu[0] == 'detail') {
                ...
                //$("#modalErrorMsg").hide();
                $('#addDetailModal2').modal('show');
                //            alert($('#addNew').attr('href'));
                $('#addDetailModalForm2').load('forms/detail-endstock-ggl.php', {
                    period: menu[1],
...
<form method="post" action="tabs/endstock_ggl-xls.php">
...
AND (ven.rsb IS NULL OR ven.rsb=0)  AND ven.ggl=1
...
<div id="addDetailModal2" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="detailModalLabel"
     aria-hidden="true" style="width:1000px; height:500px; margin-left:-500px;">
    <form id="detailForm" method="post" style="margin: 0px;" action="reports/detailEndStock-ggl-xls.php">
        ...
        <div class="modal-body" id="addDetailModalForm2">
