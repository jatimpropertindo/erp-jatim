    ...
    $(document).ready(function(){
        $("#vendorDataForm").validate({
            ...
            messages: {
				...
				curah: "PKS/Curah is a required field.",
...
<form method="post" id="vendorDataForm">
	...
	<div class="row-fluid">
        <div class="span4 lightblue">
                <label>PKS/Curah <span style="color: red;">*</span></label>
                    <?php
                    createCombo("SELECT '0' as id, 'PKS' as info UNION
                            SELECT '1' as id, 'Curah' as info;", $curah, '', "curah", "id", "info", 
                        "", 6);
                    ?>
        </div>
    </div>
