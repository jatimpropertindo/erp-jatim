...
(SELECT SUM(id.tamount_converted) FROM invoice_detail id WHERE id.pgd_id = (SELECT pgd_id FROM pengajuan_general_detail WHERE po_detail_id = pd.idpo_detail)) AS paid
