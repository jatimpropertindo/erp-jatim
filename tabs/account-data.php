...
<form method="post" id="accountDataForm">
    ...
    <div class="row-fluid">  
        <div class="span4 lightblue">
            ...
            createCombo("SELECT '0' as id, '' as info UNION
                    ...
                    SELECT '8' as id, 'Non Inventory' as info UNION
	...
	<div class="row-fluid">  
        <div class="span4 lightblue">
            <label>Show On User <span style="color: red;">*</span></label>
            <?php
            createCombo("SELECT '0' as id, 'YES' as info UNION
                    SELECT '1' as id, 'NO' as info;", $status, '', "status", "id", "info", 
                "", 1);
            ?>
        </div>
        <div class="span4 lightblue">
