...
if($result->num_rows > 0) {
    ...
    if($resultData !== false && $resultData->num_rows > 0) {
        ...
        $salesCategory = $rowData->sales_category;
    }
    ...
    $(document).ready(function(){
        ...
        $("#customerDataForm").validate({
            ...
            messages: {
                ...
                salesCategory: "This is a required field.",
...
<form method="post" id="customerDataForm">
	...
	<div class="row-fluid">
    <div class="span4 lightblue">
            <label>Sales Category <span style="color: red;">*</span></label>
            <?php
            createCombo("SELECT '1' as id, 'Export' as info UNION
                    SELECT '2' as id, 'Local' as info UNION
                    SELECT '3' as id, 'Export & Local' as info;", $salesCategory, "", "salesCategory", "id", "info",
