...
//            alert('tes');
            ...
            $('#dataContent').load('reports/notim-ls-approve.php', {
               // stockpileId: $('select[id="searchStockpileId"]').val(), 
                    soId: $('select[id="soId"]').val(),
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                <label class="control-label" for="soId">Sales Order</label>
                <div class="controls">
                    <?php 
                    createCombo("SELECT d.`so_id`, d.`so_no` FROM
                    temp_transaction a
                    ...
                    WHERE a.`status` = 0 AND c.`so_id` IS NOT NULL
                    GROUP BY d.`so_id`
                    ORDER BY so_id ASC", "", "", "soId", "so_id", "so_no", 
