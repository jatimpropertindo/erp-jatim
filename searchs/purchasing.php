...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            $('#dataContent').load('contents/purchasing.php', {
                purchasingId: $('input[id="purchasingId"]').val(),
				vendorName: $('input[id="vendorName"]').val(),
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                <label class="control-label" for="purchasingId">Purchasing Number</label>
                <div class="controls">
                   <input type="text" class="span3" tabindex="18" id="purchasingId" name="purchasingId" value="">
                </div>
			...
			<div class="control-group">
                ...
                <div class="controls">
                   <input type="text" class="span3" tabindex="18" id="vendorName" name="vendorName" value="">
                </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="3" id="periodFrom" name="periodFrom" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
            </div>
			
			<div class="control-group">
                <label class="control-label" for="periodTo">Period To</label>
                <div class="controls">
