...
<script type="text/javascript">
    $(document).ready(function(){
        $('#searchForm').submit(function(e){
            ...
            $('#dataContent').load('reports/cogs-report.php', {
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                ...
                <div class="controls">
                    <?php 
                    createCombo("SELECT sh.shipment_id, sh.sales_id, concat(s.stockpile_code, ' - ',MAX(sh.shipment_date), ' - ',sh.shipment_no, ' - ' , RIGHT(sh.shipment_code ,2)) AS shipment_code
                                FROM shipment sh
                                INNER JOIN sales sl
                                ...
                                GROUP BY sales_id ORDER BY MAX(sh.shipment_date) DESC, sh.shipment_code DESC", "", "", "searchShipmentId", "sales_id", "shipment_code", 
