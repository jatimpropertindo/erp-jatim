...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#searchForm').submit(function(e){
            e.preventDefault();
//            alert('tes');
            $('#dataContent').load('reports/general-ledger-report-old.php', {
            ...
            <div class="control-group">
                ...
                <div class="controls">
                   ...
                   createCombo("SELECT 'CONTRACT' AS id, 'CONTRACT' AS info UNION
								...
								SELECT 'INVOICE SALES' AS id, 'INVOICE SALES' AS info UNION
								SELECT 'INVOICE SALES OA' AS id, 'INVOICE SALES OA' AS info UNION
								...
								SELECT 'RETURN PAYMENT' AS id, 'RETURN PAYMENT' AS info UNION
                                SELECT 'RETURN INVOICE SALES' AS id, 'RETURN INVOICE SALES' AS info UNION
                                SELECT 'RETURN INVOICE SALES OA' AS id, 'RETURN INVOICE SALES OA' AS info", "", "", "glModule", "id", "info",
