...
//            alert('tes');
            ...
            $('#dataContent').load('contents/search-notim-local-sales.php', {
                notim: $('input[id="notim"]').val(), 
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            <div class="control-group">
                <label class="control-label" for="notim">Slip No (Only Number)</label>
                <div class="controls">
                   <input type="text" class="span1" tabindex="18" id="notim" name="notim" value="">
                </div>
