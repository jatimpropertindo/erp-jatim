...
//            alert('tes');
        ...
        var start= $("#searchPeriodFrom").datepicker("getDate");
    	var end= $("#searchPeriodTo").datepicker("getDate");
   		days = (end- start) / (1000 * 60 * 60 * 24);
        //alert (days);


			if(days > 100 && $('select[id="searchStockpileId"]').val() == '') {
                alertify.set({ labels: {
                    ok     : "OK"
                } });
                alertify.alert("Please Select Stockpile When Period More Than 100 Days");
			} else {
                
                $.blockUI({ message: '<h4>Please wait...</h4>' }); 
                $('#dataContent').load('reports/notim-report-mutasi.php', {
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    createCombo("SELECT s.stockpile_code, CONCAT(s.stockpile_code, ' - ', s.stockpile_name) AS stockpile_full
                                ...
                                ORDER BY s.stockpile_code ASC, s.stockpile_name ASC", "", "", "searchStockpileId", "stockpile_code", "stockpile_full", 
                                "", 7, "select2combobox100", 7, "");
                    ?>
                </div>
            </div>
            <div class="control-group">
