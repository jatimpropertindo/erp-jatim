...
//            alert('tes');
            ...
            if($('input[id="searchPeriodTo"]').val() != '') {
                ...
                $('#dataContent').load('forms/endStock-ls.php', {
                ...
                alertify.alert("Period To is required field.");
            }
        });
    });
    ...
    <div class="offset3 span3">
        <form class="form-horizontal" id="searchForm" method="post">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" placeholder="DD/MM/YYYY" tabindex="2" id="searchPeriodTo" name="searchPeriodTo" data-date-format="dd/mm/yyyy" class="datepicker" >
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
