...
$allowSalesInvoiceOld = false;
$allowNotimSustain = false;
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_object()) {
        if ($row->module_id == 1) {
            ...
            $allowPerdinHRD = true;
        } elseif ($row->module_id == 68) {
            $allowSalesInvoiceOld = true;
        } elseif ($row->module_id == 69) {
            $allowNotimSustain = true;
        }
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php } ?>
										...
										<?php if ($allowNewNotimPhoto) { ?> 
                                        <li class="divider"></li>
                                        <li><a href="#notim-local-sales">Input Notim Local Sales (IN+OUT)</a></li>
                                        <li><a href="#notim-local-sales-out">Input Notim Local Sales (OUT)</a></li>
                                        <li><a href="#search-notim-local-sales">Search Notim Sales</a></li>
                                        <li><a href="#notim-ls-approve">Approval Notim Local Sales</a></li>
                                    <!-- <li><a><button class="btn btn-default" id="transfer" onclick= "transfer()">Transfer Data Timbangan</button></a></li> -->
                                    <?php } ?>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <?php if ($allowPayment) { ?>
										...
										<li><a href="#batchUpload">Batch Upload</a></li>
										<li><a href="#payment-notim-salesOA">Payment Local Sales OA/OB/Handling</a></li>
						...
						if ($allowInvoice) { 
							...
							$sql = "SELECT COUNT(*) AS jumlah FROM pengajuan_payment_sales a WHERE status = 0";
						$resultData = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
						if ($resultData->num_rows > 0) {
						while ($row = $resultData->fetch_object()) {
							if($row->jumlah > 0){
							...
							$sql1 = "SELECT COUNT(*) AS jumlah FROM invoice_sales a WHERE status_payment = 0 AND invoice_status = 1";
						$resultData1 = $myDatabase->query($sql1, MYSQLI_STORE_RESULT);
						if ($resultData1->num_rows > 0) {
						while ($row1 = $resultData1->fetch_object()) {
							if($row1->jumlah > 0){
							$jumlah1 = $row1->jumlah;
							}
							}
                        ...
                        $jumlahTotal = $jumlah + $jumlah1;

                    }
                        ?>
						
						<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge badge-info"><?php echo $jumlahTotal; ?></span>Local Sales Invoice<b class="caret"></b></a>
						<ul class="dropdown-menu">
						<li><a href="#pengajuan-notim-sales">Create Invoice Receivable</a></li>
                        <?php if ($allowInvoice) { ?>
						<li><a href="#invoice-notim-sales">Register Invoice Receivable (<?php echo $jumlah; ?>)</a></li>
						<li><a href="#payment-notim-sales">Receivable Payment (<?php echo $jumlah1; ?>)</a></li>
                        <?php } ?>
						</ul>
						</li>
						...
						$jumlahTotal = '';
						$jumlah = '';
							$sql = "SELECT COUNT(*) AS jumlah FROM perdin_adv_settle a WHERE (CASE WHEN a.sa_method = 1 THEN a.approval_status ELSE 1 END) = 1 AND a.upload_status = 1 AND a.invoice_status = 0 AND a.payment_from = 0";
						$resultData = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
						if ($resultData->num_rows > 0) {
						while ($row = $resultData->fetch_object()) {
							if($row->jumlah > 0){
						...
						$jumlah3 = '';
							$sql3 = "SELECT COUNT(*) AS jumlah FROM pengajuan_payment WHERE status = 0 AND email_date IS NOT NULL ";
						...
						$jumlahTotal = (int)$jumlah + (int)$jumlah2 + (int)$jumlah3 + (int)$jumlah4;
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#logbook_new">Logbook-New</a></li>
                                    ...
                                    <li><a href="#invoice-notim-views">Register Invoice OA/OB/Curah (<?php echo $jumlah3; ?>)</a></li>
									<li><a href="#invoice-ls-oa">Register Invoice Local Sales OA/OB/Handling(<?php echo $jumlah4; ?>)</a></li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <?php if ($allowSalesAgreement) { ?>
										...
										<li class="dropdown-submenu">
                                            <a tabindex="-1" href="#">Local Sales</a>
                                            <ul class="dropdown-menu">
                                                <li><a href="#sales-local-contract">Local Sales Contract</a></li>
                                                <li><a href="#sales-local-order">Local Sales Order</a></li>
                                                <li><a href="#sales-local">Local Sales Code</a></li>
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown-submenu">
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if ($allowAccountingReport) { ?>
												...
												<li><a href="#endStock-ls-report">End Stock Report (LS)</a></li>
                                                <li><a href="#general-ledger-report">General Ledger</a></li>
												<!--<li><a href="#general-ledger-report-old">General Ledger old</a></li>-->
											...
											<?php if ($allowNotimSustain) { ?>
                                            <li><a href="#notim-report-sustain">Notim Sustain Report</a></li>
                                            <li><a href="#notim-report-mutasi">Mutasi Notim Report</a></li>
                                            <li><a href="#closing-stock-report">Closing Stock Report</a></li>
                                            <?php } ?>
                                    ...
                                    <?php if ($allowFinanceReport) { ?>
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a href="#bank-book-report">Bank Book</a></li>
                                                <li><a href="#vendor-activity-report">Vendor Activity Report (Payment)</a></li>
                                                <li><a href="#vendor-activity-report-inv">Vendor Activity Report (Invoice)</a></li>
									...
									<?php if ($allowDataVendor) { ?>
                                        <li class="dropdown-submenu">
                                            <a tabindex="-1" href="#">Data Vendor</a>
                                            <ul class="dropdown-menu">
                                    ...
                                    <?php } ?>
                                    <li><a href="#export-notim">Export Nota Timbang</a></li>
                                </ul>
                            </li>
                        <?php } ?>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php if ($allowPrivilegeConfiguration) { ?>
                                    <li class="dropdown-submenu">
                                        <a tabindex="-1" href="#">Modules</a>
                                        <ul class="dropdown-menu">
                                            <li><a href="#module">User Modules</a></li>
											<li><a href="#modulesupport">IT Support Module</a></li>
                                        </ul>
                                    </li>
                                    <?php
                                }
                                ...
                                <?php if ($allowTaxConfiguration) { ?>
									<li class="dropdown-submenu">
                                        <a tabindex="-1" href="#">All Vendors</a>
                                        <ul class="dropdown-menu">
                                    <li><a href="#vendor-handling">Vendors Handling</a></li>
									<li><a href="#freight-local-sales">Freights Local Sales</a></li>
                                    <li><a href="#labor-local-sales">Labor Local Sales</a></li>
                                    <li><a href="#handling-local-sales">Handling Local Sales</a></li>
                        ...
                        <?php
                        $jumlah2 = '';
							$sql = "SELECT COUNT(*) AS jumlah FROM perdin_adv_settle WHERE `approval_status`= 1 AND invoice_status = 0 AND entry_by = {$_SESSION['userId']}";
						$resultData = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
						if ($resultData->num_rows > 0) {
						while ($row = $resultData->fetch_object()) {
							if($row->jumlah > 0){
                        ...
                        ?>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge badge-info"><?php echo $jumlah2; ?></span>Pengajuan <b
                                        class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="#pengajuan-general">Pengajuan General</a></li>
                                <li><a href="#pengajuan-notim-views">Pengajuan OA/OB/Curah</a></li>
								<?php if ($allowTaxReport) { 
								$jumlah = '';
							   ...
							   ?>
								...
								<li><a href="#pengajuan-payment-sales">Pengajuan OA/OB/Handling Local Sales</a></li>
								
								<li class="divider"></li>
								<li class="nav-header">PERJALANAN DINAS</li>
								<li><a href="#perdin-surat">Surat Perjalanan Dinas</a></li>
								<li><a href="#perdin-adv_settle">Pengajuan Advance/Settle/Reimburse(<?php echo $jumlah2; ?>)</a></li>
                        ...
                        ?>
						<?php if ($allowSalesInvoiceOld) { ?>
						<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="badge badge-info"><?php //echo $jumlahTotal; ?></span>Account Receivable<b class="caret"></b></a>
						<ul class="dropdown-menu">
						<li><a href="#proforma-invoice">Proforma Invoice</a></li>
                        
						<li><a href="#invoice-notim-sales-old">Register Invoice Receivable (<?php //echo $jumlah; ?>)</a></li>
						<li><a href="#payment-notim-sales-old">Receivable Payment (<?php //echo $jumlah1; ?>)</a></li>
                        <?php } ?>
						</ul>
						</li>
                    </ul>
