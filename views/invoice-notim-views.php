...
$_SESSION['menu_name'] = 'Invoice Notim';

?>

<script type="text/javascript">
    $(document).ready(function(){
        $('#dataContent').load('contents/invoice-notim-content.php', {}, iAmACallbackFunction2);
        $('#dataSearch').load('searchs/invoice-notim-search.php', {}, iAmACallbackFunction2);
    });
</script>
