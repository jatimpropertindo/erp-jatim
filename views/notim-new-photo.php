...
//        });
       ...
       $('#qty_rsb').number(true, 2);
        ...
        $('#qty_uncertified').change(function() {
            getValidationUN($('select[id="stockpileId"]').val(), $('input[id="qty_uncertified"]').val());
        });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (parseInt(returnVal[3]) != 0)	//if no errors
                        {
                            ...
                            if (returnVal[1] == 'OK') {
                                $('#pageContent').load('views/notim-new-photo.php', {}, iAmACallbackFunction);
                            } 
...
//                    }                  
    ...
    function getValidationUN(stockpileId, sendWeight2) {
            //alert(idPP);
        $.ajax({
            url: 'get_data.php',
            method: 'POST',
...
//                        $('#supplierId').attr("disabled", true);
                    ...
                    setContractPksDetail(0, $('input[id="vendorId"]').val());
                }
            }
        });
    }
...
//                        $('#supplierId').attr("disabled", true);
                ...
                setContractPksDetail(0, returnVal[10]);
...
//                    }                  
    ...
    $('#showPhoto').click(function () {
        ...
        $('#snapPhotoModal').load('views/notim-new-showImage.php', {transactionNewId: $('#idSuratTugas').val(),type: 'pic'});
    ...
    $('#showTruck').click(function () {
        $('#snapPhotoModal').modal('show');
        // $('#snapPhotoModal').innerHTML = '<img id="base64image" src="'+sessionStorage.getItem("file")+'"/>';
        $('#snapPhotoModal').load('views/notim-new-showImage.php', {transactionNewId: $('#idSuratTugas').val(),type: 'truck'});
    });
</script>
