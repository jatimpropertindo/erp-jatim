...
//            $("#transactionContainer").hide();
		 ...
		 //################## Add Custom By Haris : Attribute Readonly Filter By Stockpile Padang ################### //

        var stockpileId = $('#stockpileId').val();
        AdditionalShrink(stockpileId);

        $('#stockpileId').on('change', function(e) {
        ...
        function AdditionalShrink(stockpile_id) {
            $('#qtyAddShrink').attr('readonly', false);
            $('#priceAddShrink').attr('readonly', false);

            if(stockpile_id == '4') {
                $('#qtyAddShrink').attr('readonly', true);
                $('#priceAddShrink').attr('readonly', true);
            }
        }

		//################## End Custom By Haris : Attribute Readonly Filter By Stockpile Padang ################### //
...
<form method="post" id="transactionDataForm">
    ...
    <input type="hidden" name="_method" value="INSERT_PREVIEW">
        ...
        <div class="row-fluid">
            ...
            <div class="span2 lightblue">
                <label style="color: blue;"><b>ISCC : <span id="availabel_rsb"></span></b></label>
            </div>
            <div class="span2 lightblue">
            ...
            <div class="span2 lightblue">
                <label>ISCC <span style="color: red;"></span></label>
            </div>
            <div class="span2 lightblue">
                <?php
        ...
        <div class="row-fluid">
            ...
            <div class="span2 lightblue">
                <label  style="color: blue;"><b>ISCC-GGL : <span id="availabel_rsb_ggl" ></span></b></label>
            </div>
            <div class="span2 lightblue">
        ...
        <div class="row-fluid">
            ...
            <div class="span2 lightblue">
                <label>ISCC & GGL <span style="color: red;"></span></label>
            </div>
            <div class="span2 lightblue">
                <?php
                createCombo("SELECT '0' as id, 'NONE' as info UNION
