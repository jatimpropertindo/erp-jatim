...
//                resetFreightDetail();
        ...
        $('#laborId').change(function () {
		  ...
		  $("#qtyAddShrink, #priceAddShrink").on("keydown keyup", function () {
            getAmountClaim();
            $('#newAmountClaim').number(true, 10);
        });
...
//                        alert(data);
	...
	//function getAmountClaim(qtyAddShrink, priceAddShrink) {
      //  if (qtyAddShrink.value != '' && priceAddShrink.value != '') {
        ...
        //}
    //}
	  function getAmountClaim() {
        const num1 = document.getElementById('qtyAddShrink').value;
        const num2 = document.getElementById('priceAddShrink').value;

        var result = (parseFloat(num1) * parseFloat(num2));
        if (!isNaN(result)) {
            document.getElementById('newAmountClaim').value = result;
...
<form method="post" id="transactionDataForm">
	...
	<!-- end add new detail standard shrink - eva -->
		...
		<div class="row-fluid">
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="30" id="qtyAddShrink" name="qtyAddShrink">
            </div>
        </div>
        <div class="row-fluid">
            <!-- <div class="span2 lightblue"></div>
            ...
            <div class="span4 lightblue">
                <input type="text" class="span12" tabindex="30" id="priceAddShrink" name="priceAddShrink">
            </div>
        </div>
        <div class="row-fluid">
            <!-- <div class="span2 lightblue"></div>
