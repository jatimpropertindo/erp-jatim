...
//                if(document.getElementById('paymentMethod').value == 2) {
                refreshInvoice($('select[id="invoiceId"]').val(), $('select[id="paymentMethod"]').val(), 'NONE', 'NONE');
				                getEmails($('select[id="invoiceId"]').val());
	...
	function getRate(invoice_id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (parseInt(returnVal[0]) != 0)	//if no errors
                {
                    document.getElementById('exchangeRate').value = returnVal[1];
    ...
    function getEmails(invoice_id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (parseInt(returnVal[0]) != 0)	//if no errors
                {
                    document.getElementById('gv_email').value = returnVal[1];
                    document.getElementById('gv_email2').value = returnVal[2];
...
//                    document.getElementById('exchangeRate').value = returnVal[3];
                    ...
                    if (returnVal[1] == 1 && returnVal[1] == returnVal[2] && returnVal[1] == returnVal[3]) {
						...
						if(document.getElementById('invoiceId').value !== '' && document.getElementById('invoiceId').value !== 0){
						...
						if(document.getElementById('invoiceId').value !== '' && document.getElementById('invoiceId').value !== 0){
                            ...
                            getRate($('select[id="invoiceId"]').val());
                        }
...
<form method="post" id="paymentDataForm">
    ...
    <input type="hidden" id="gv_email" name="gv_email"/>
