...
//							if ($reqPaymentDate == NULL || $paymentType == 0 || $reqPaymentDate == '') {
							if ($reqPaymentDate == NULL || $reqPaymentDate == '' || is_null($reqPaymentDate) || $reqPaymentDate == 'NULL') {
                                ...
                                tax_date, invoice_method, stockpileId, pengajuan_no, invoice_no2, invoice_tax, remarks,po_id, file, company_id, entry_by, entry_date, pic_email) VALUES ("
                                    ...
                                    . "'{$attachmentPath}', {$_SESSION['companyId']}, {$_SESSION['userId']}, STR_TO_DATE('$currentDate', '%d/%m/%Y %H:%i:%s'), '{$picEmail}')";
                                $result = $myDatabase->query($sql, MYSQLI_STORE_RESULT);
                                // echo $sql;
